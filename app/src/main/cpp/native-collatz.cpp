...
JNICALL
Java_com_selfsimilartech_fractaleye_FractalRenderer_iterateCollatzNative(
        JNIEnv *env,
        jobject, /* this */
        jobject data) {
...
//        }
        ...
        for (int x = 0; x < width; x++) {
            ...
            for (int n = 0; n <= maxIter; n++) {
                ...
                // shape loop
                z = cadd(cmult(0.25, cadd(csub(cmult(7.0, z1), cmult(cadd(cmult(5.0, z1), 2.0), ccos(cmult(M_PI, z1)))), 2.0)), c);
