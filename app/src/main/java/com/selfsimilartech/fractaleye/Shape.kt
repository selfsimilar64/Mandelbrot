...
class Shape (
        ...
        private val positions   : PositionList          = PositionList(),
    ...
    companion object {
        ...
        val burningShipPow = Shape(
                ...
                positions           = PositionList(Position(x = 0.15, y = -0.15, zoom = 4.0, rotation = 0.5*Math.PI)),
                devFeature          = true
        )
        val magnet1 = Shape(
                id                  = nextId,
        ...
        val kleinian = Shape(
                ...
                params              = ParamList(
                        ...
                        listOf(
                                ...
                                RealParam(u = 0.0, uRange = Range(0.0, 8.0), discrete = true, devFeature = true),
    ...
    init {
        if (!hasAnalyticDelta) {
            delta1 = "delta(_float(z), ${loop.replace("z1, c", "_float(z1) + vec2(0.0001, 0.0), _float(c)")}, alpha)"
            alphaSeed = Complex.ONE
        }
